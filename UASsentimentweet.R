...
setwd("C:/Users/Zorez/Documents/Semester 7/Data WareHouse/R/UAS")
...
some_tweets<- twListToDF(some_tweets)
 write.table(some_tweets,"C:/Users/Zorez/Documents/Semester 7/Data WareHouse/R/UAS/sentimenttweet.csv", append=T, row.names=F, col.names=T,  sep=",")

df<- read.csv("C:/Users/Zorez/Documents/Semester 7/Data WareHouse/R/UAS/sentimenttweet.csv", stringsAsFactors = FALSE)
glimpse(df)

df$class <- as.factor(df$class)
custom_stopwords <- read.csv("C:/Users/Zorez/Documents/Semester 7/Data WareHouse/R/UAS/stopword.csv", header = FALSE)
...
dr<- read.csv("C:/Users/Zorez/Documents/Semester 7/Data WareHouse/R/UAS/sentiment.csv", stringsAsFactors = FALSE)
factor(dr$class)
